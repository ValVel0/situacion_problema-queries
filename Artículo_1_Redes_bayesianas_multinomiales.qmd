...
```{r}
prob1 = cpquery(bn,event = (p5_6 == "8" & p5_7_7 == "31"), #Salió de un hospital en Yucatán
  evidence = (p5_14_01 == "1" | p5_14_19 == "1"), #Utilizó automóvil o transporte de personal
  n = 10^6
)
...
# Jóvenes 
sum(base_final$edad > 17 & base_final$edad < 30, na.rm = TRUE)
...
evidencia <- base_final$sexo == "1" & 
             ...
             base_final$edad > 17 & base_final$edad < 30 & 
