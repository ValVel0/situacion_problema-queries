...
Con esto confirmamos que $\text{p-value} > 0.05$ para cada caso de los arcos, de manera que se rechaza la hipótesis nula $H_0$ y existe suficiente evidencia para decir que son verdaderas las relaciones de dependencia entre los nodos de la DAG con restricciones. 
